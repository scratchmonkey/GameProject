...
namespace GameProject
{
    ...
    public class Game1 : Game
    {
        ...
        private void SpawnBear()
        {
            ...
            int randX = GetRandomLocation(GameConstants.SpawnBorderSize,
                GameConstants.WindowWidth - GameConstants.SpawnBorderSize);
            int randY = GetRandomLocation(GameConstants.SpawnBorderSize,
            ...
            Vector2 velocity = new Vector2(speed, angle); 

            // create new bear
            TeddyBear newBear = new TeddyBear(Content, @"Graphics\teddybear", randX, randY, velocity, null, null);
